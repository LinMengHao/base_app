package com.xzkj.baseservice.aop;

import com.xzkj.baseservice.annotation.DS;
import com.xzkj.baseservice.constants.DataSourceConstants;
...
public class DynamicDataSourceAspect {
    //切入点,@DS标记的类，和方法做切入
    @Pointcut("@annotation(com.xzkj.baseservice.annotation.DS)"
            + "|| @within(com.xzkj.baseservice.annotation.DS)")
